...
# Heavy libraries (pandas, matplotlib, seaborn, sklearn) are imported lazily
# inside functions to avoid expensive imports at application startup.

def preprocess_data(data):
    # Local imports to reduce startup cost
...
def main():
    ...
    # Plotting (import heavy plotting libraries only when needed)
